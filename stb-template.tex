...
\newpage
(pg 28)\\
to have the ability to produce such displacement accompanied by force in the direction of the displacement, that is to say, the ability to produce the quantity that we call \textit{work}.

Whether it is drawn from animals, from moving water or air, from the combustion of coal, or from the fall of bodies, it is limited for each time, for each place; it cannot be created at will. Machines merely employ and economize work without being able to increase it; thus, the ability to produce it is bought, sold, and economized like all useful things that are not in extreme abundance.
    If we did not have machines at our disposal, two different displacements would be two things of distinct natures, generally admitting no mathematical basis for their evaluation: it would be for these displacements as it is for many useful things whose values are not generally established on mathematical calculations. But machines, as we will see, provide the means to establish for displacements bases of evaluation similar to those we have for quantities of the same material.

When a machine, which receives its moving forces from a certain motor, is intended to perform a certain useful effect, it results that the points acting on the bodies to be displaced or deformed receive from these bodies resistant forces; but these forces are generally not the only ones producing resistant work; friction and various other resistances, from which one cannot free oneself, add resistant work to that resulting from the useful effect. However, since there is a rational possibility to leave subsisting as resistant forces only those arising from the useful effect, or at least to considerably reduce all other forces compared to these, we can initially reason under this hypothesis, just as one first reasons about machines by disregarding friction: it will be easy to see how, in practice, to modify the conclusions drawn from this first abstraction. Let us therefore assume, for the moment, that all resistant work is produced by the useful effect alone.

Note that if we have the ability to produce a displacement by exerting a certain effort, we can, with the help of a machine that appropriately modifies the movement and the forces,
\newpage
%note on the phrasing "on the machine" - I was unsure if this was the correct translation and asked ChatGPT about it. I may need to follow up with other resources to confirm that this is correct. 
%from conversation with ChatGPT about the phrasing: [ChatGPT]"It was common to describe machines as objects through which forces or actions passed. This makes "on the machine" a faithful reflection of both the original wording and the era's mechanical philosophy. Any deviation to "by the machine" might risk modernizing the text too much, potentially altering Coriolis's meaning."
%[me]"Nowadays we would write "by the machine", but "on the machine" makes sense with the context of how work was thought of at the time"
%[ChatGPT] "You're absolutely right—"by the machine" would feel more intuitive in modern writing, especially since we now tend to personify machines as active agents in producing work. But sticking to "on the machine" honors the context of how Coriolis and his contemporaries conceptualized mechanical systems as passive intermediaries in the transmission of forces."

This perspective reflects how work was understood in the 19th century, when machines were seen less as creators of energy and more as entities through which energy was transmitted or transformed. Coriolis's focus on resistant work reinforces this viewpoint, as it emphasizes the physical interaction of forces and motions happening "on" the machine's components.
(pg.29)
apply this ability to carry out a certain fabrication, for example, to grind wheat or to spin thread. It is clear that the milling of each liter of wheat or the spinning of each meter of thread, generally accompanied by the same circumstances, will require the points on which the machine acts to describe the same path while receiving the same force. Thus, this milling or twisting of thread will always result in the production of the same quantity of what we have called \textit{resistant work}: consequently, the number of liters of wheat milled or meters of thread twisted by means of this capacity for motion will be proportional to the resistant work produced on the machine by this milling or spinning. Now, according to the assumption we just made, that external resistances unrelated to the useful effect could initially be neglected, this quantity of resistant work alone constitutes all the work produced on the machine, so that, when considering this work over a period of time that is not very short, it is approximately equal to the motive work; this motive work will therefore also be proportional to the quantity of wheat milled or thread twisted.

If one wants to compare two capacities for motion, it will suffice to imagine that machines are constructed through which these capacities can be applied to the same production—for example, milling wheat: the number of liters of wheat that can be milled will similarly be approximately proportional to the quantities of motive work produced on these machines using these capacities for motion. But it is clear the comparative value of the two milling capacities will be measured by the numbers of liters of wheat milled; and since these quantities are approximately proportional to the motive work produced on each machine, it follows that the two capacities for motion will have values proportional to the quantities of work they can produce on these machines.

Thus, it is due to the ease that we have today, and will increasingly have, of constructing machines to apply different capacities for motion, that is, different motors, to execute the same type of work with these machines, that we can establish a method of comparison between these motors through the quantities of the same work they are capable of producing. The invention, improvement, and multiplication of machines have
\newpage
(pg 30)\\
led to and will increasingly spread this method of evaluation, much like the invention and improvement of tools for dividing materials have led to and spread the measurement of their value in commerce by the geometric quantity called volume.
